...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ultra-premium fitness experience. Personal training, AI diet plans, and elite coaching at K Fit Gym." },
      { property: "og:title", content: "K Fit Gym" },
